...
# Need to update data sheets prior to adadpting this further...
...
# Pasted previous function ####
# Must adapt for new data inputs and ability to select factor
# Generalize for "X" and "Y" formatting
data = read.csv("../data/fao_composite_tall.csv", header = T, sep = ",")
X = "kcal.ha.tot"
Y = "tonnes_nitrogen"
start = 2000
end = 2018
